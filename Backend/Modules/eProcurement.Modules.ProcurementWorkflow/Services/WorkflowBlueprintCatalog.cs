...
internal static class WorkflowBlueprintCatalog
{
    ...
    [
        ...
        new("budget_allocation_and_confirmation", "app_planning", "Budget Allocation and Confirmation", "Assign budget code and confirm funding readiness before committee review.", 3, true, false, false, "PPA 2007 s.16, s.18", ["financial_unit_officer"], ["budget.confirm"]),
    ...
    [
        ...
        new("department_head_endorsement", "budget_allocation_and_confirmation", "Department Head endorsement completed."),
        new("budget_allocation_and_confirmation", "comptroller_procurement_review", "Budget allocation and confirmation completed for planning review."),
        new("comptroller_procurement_review", "planning_committee_review", "Comptroller Procurement approves for committee review."),
        new("planning_committee_review", "department_head_endorsement", "Committee returns the request to the department for rework."),
        new("planning_committee_review", "app_approval", "Committee review complete and routed for APP approval."),
        new("app_approval", "planning_committee_review", "APP approval returns the plan for committee rework."),
        new("app_approval", "accounting_officer_review", "Comptroller Procurement forwards the committee-approved plan to CGIS for approval."),
        new("accounting_officer_review", "procurement_initiation", "CGIS approves the plan and procurement may now be initiated."),
    ...
    [
        ...
        new("financial_unit_officer", "Budget Officer", "budget_allocation_and_confirmation", "Allocate budget code and confirm funds for the request.", "Budget allocation and confirmation are recorded."),
        ...
        new("accounting_officer", "CGIS", "app_approval", "Provide Comptroller General of Immigration Service concurrence before the APP is released for execution.", "APP approval includes CGIS control."),
