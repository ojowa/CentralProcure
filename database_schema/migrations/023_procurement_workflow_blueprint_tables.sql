...
FROM (
    VALUES
        ...
        ('comptroller_procurement_review', 'app_planning', 'Comptroller Procurement Review', 'Comptroller Procurement approves the request for Planning Committee review.', 4, FALSE, FALSE, FALSE, 'comptroller_procurement', 'PPA 2007 s.18, s.21'),
        ('planning_committee_review', 'app_planning', 'Planning Committee Review', 'Validate need, packaging, aggregation, and cost assumptions.', 5, FALSE, FALSE, FALSE, 'comptroller_procurement', 'PPA 2007 s.18, s.21'),
        ('app_approval', 'app_planning', 'APP Approval', 'Approve the annual procurement plan for execution.', 6, TRUE, FALSE, FALSE, 'comptroller_procurement', 'PPA 2007 s.16, s.18'),
        ('procurement_initiation', 'threshold_control', 'Procurement Initiation', 'Activate an approved APP line for execution.', 7, FALSE, FALSE, FALSE, 'comptroller_procurement', 'PPA 2007 s.16, s.19'),
        ('threshold_resolution', 'threshold_control', 'Threshold Resolution', 'Resolve approval route, board gate, and BPP need.', 8, TRUE, FALSE, FALSE, 'comptroller_procurement', 'PPA 2007 s.16, s.17'),
        ('method_validation', 'threshold_control', 'Method Validation', 'Confirm the lawful procurement method and route.', 9, TRUE, FALSE, FALSE, 'legal_reviewer', 'PPA 2007 s.24-s.52'),
        ('solicitation', 'procurement_execution', 'Advert / Invitation / EOI / RFP', 'Publish advert or issue invitations/EOI/RFP.', 10, FALSE, FALSE, FALSE, 'comptroller_procurement', 'PPA 2007 s.19, s.25, s.44-s.48'),
        ('bid_opening', 'procurement_execution', 'Bid Opening', 'Record public opening and attendance.', 11, FALSE, FALSE, FALSE, 'comptroller_procurement', 'PPA 2007 s.30'),
        ('evaluation', 'procurement_execution', 'Evaluation', 'Evaluate against published criteria only.', 12, FALSE, FALSE, FALSE, 'evaluation_committee', 'PPA 2007 s.31-s.33, s.49-s.52'),
        ('tenders_board_review', 'procurement_execution', 'Tenders Board Review', 'Board review of evaluation recommendation.', 13, TRUE, FALSE, FALSE, 'tenders_board', 'PPA 2007 s.17, s.19, s.22'),
        ('accounting_officer_review', 'procurement_execution', 'CGIS Approval', 'Accounting officer final accountable gate.', 14, TRUE, FALSE, FALSE, 'accounting_officer', 'PPA 2007 s.16, s.20'),
        ('bpp_no_objection', 'procurement_execution', 'BPP No Objection', 'Prior review and no-objection gate for applicable thresholds.', 15, TRUE, FALSE, FALSE, 'bpp_liaison', 'PPA 2007 s.16, s.19'),
        ('award_and_publication', 'post_award', 'Award and Publication', 'Issue award notice and publish award record.', 16, FALSE, FALSE, FALSE, 'comptroller_procurement', 'PPA 2007 s.19, s.33'),
        ('contract_execution', 'post_award', 'Contract Execution', 'Manage contract signing, security, mobilisation, and milestones.', 17, FALSE, FALSE, FALSE, 'contract_manager', 'PPA 2007 s.35-s.37'),
        ('inspection_and_payment', 'post_award', 'Inspection and Payment', 'Record inspection, acceptance, and payment readiness.', 18, FALSE, FALSE, FALSE, 'inspection_officer', 'PPA 2007 s.19, s.37'),
        ('closeout_and_audit', 'review_and_oversight', 'Closeout and Audit', 'Archive records, complete closeout, and preserve audit trace.', 19, FALSE, FALSE, TRUE, 'audit_oversight', 'PPA 2007 s.16, s.38'),
        ('administrative_review', 'review_and_oversight', 'Administrative Review', 'Handle bidder complaint and statutory review path.', 20, FALSE, FALSE, FALSE, 'complaints_review_officer', 'PPA 2007 s.54')
) AS seed (
    stage_key,
    phase_key,
    stage_title,
...
FROM (
    VALUES
        ...
        ('comptroller_procurement', 'Comptroller Procurement', 'app_approval', 'Approve the annual procurement plan as head of the procurement unit.', 'APP is approved for execution.'),
        ...
        ('comptroller_procurement', 'Comptroller Procurement', 'procurement_initiation', 'Open procurement package from approved APP line.', 'Execution begins only from approved APP entries.'),
        ('comptroller_procurement', 'Comptroller Procurement', 'threshold_resolution', 'Resolve threshold band and approval route as head of the procurement unit.', 'Approval path and BPP gate are explicit.'),
        ...
        ('comptroller_procurement', 'Comptroller Procurement', 'solicitation', 'Publish advert or issue invitations.', 'Solicitation is opened lawfully.'),
        ...
        ('accounting_officer', 'CGIS', 'accounting_officer_review', 'Exercise direct low-value approval authority.', 'CGIS decision is recorded before award publication.'),
